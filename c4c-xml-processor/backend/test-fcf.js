...
async function testFCFProcessor() {
  try {
    console.log('=== FCF Processor Test ===');
    
    const filePath = path.resolve('../../input/FCF2025-03-10-868.xml');
    console.log('Processing FCF file:', filePath);
